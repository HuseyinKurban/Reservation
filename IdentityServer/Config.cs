    ...
    public static class Config
    {
        ...
        public static IEnumerable<Client> Clients => new Client[]
        {
            ...
            new Client
            {
                ...
                ClientSecrets = { new Secret("reservationsecret".Sha256()) },
                AllowedScopes = { "BookingFullPermission", "BookingReadPermission", "BookingUpdatePermission","ReviewFullPermission","PaymentFullPermission","BasketFullPermission","MessageFullPermission",
